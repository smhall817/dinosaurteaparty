...
# DinosaurTeaPartyFunctionV1, with all text output removed.
# To change the number of games played, simply change the
# num_games variable.


from DinosaurTeaPartyFunctionV1 import play
import csv
...
color_dict = {'Amelia' : 'green', 'Beatrice' : 'mediumpurple', 'Carlton' : 'mediumpurple',
              'Dennis' : 'mediumpurple', 'Eleanor' : 'green', 'Gerald' : 'green',
              'Harriet' : 'mediumpurple', 'Jeannine' : 'mediumpurple', 'Kenneth' : 'mediumpurple',
              'Lloyd' : 'green', 'Nigel' : 'green', 'Quinton' : 'darkorange',
              'Reginald' : 'darkorange', 'Sebastian' : 'darkorange', 'Tabitha' : 'green',
              'Ulysses' : 'green', 'Vincent' : 'darkorange', 'Winston' : 'darkorange',
              'Xavier' : 'darkorange', 'Yorick' : 'green'}


axs2.bar([i[0] for i in means], [i[1] for i in means], color = [color_dict[i] for i in dino_set])
